...
parser.add_argument("--project_dir", type=str, required=False, default='D:\\prolen\\HDSF\\', help="project directory")
parser.add_argument("--dropout", type=float, required=False, default=0.3, help="Value of droupout")
parser.add_argument("--sim_name", type=str, required=False, default="sim1",help="The unique and arbitrary name of simulation")
parser.add_argument("--l2_coeff", type=float, required=False, default=0.000 ,help="Value L2 regularization coefficient")
...
parser.add_argument("--batch_size", type=int, required=False, default=32, help="size of batch")
parser.add_argument('--step_num', type=int, required=False, help=' number of steps to run the simulation.', default=80)
...
parser.add_argument('--blstm_hidden_unit_dim', default=120, type=int)
